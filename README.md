...
No requiere build ni dependencias. Basta con abrir `HTML/index.html` en el
...
Al ser HTML/CSS/JS estático, puede desplegarse en cualquier hosting
estático (Netlify, Vercel, GitHub Pages, etc.) apuntando la raíz del sitio
a `HTML/index.html`.
